...
# ==================================================
    ...
    body_analysis = {
        ...
        "상체가 발달한 체형":
            "상체의 볼륨감을 자연스럽게 분산하고 하체에 적당한 볼륨을 더하는 실루엣을 추천했어요.",
    ...
    st.markdown(
        '<div class="question">✨ 당신을 위한 추천 코디</div>',
        unsafe_allow_html=True
    )

    st.markdown(
        f'<div class="progress">'
        f'{gender} · {body} · {style} · {color} · {situation}'
        f'</div>',
        unsafe_allow_html=True
    )
    ...
    <div class="result-card">
        ...
        <div class="result-text">
            선호 색상 <b>{color}</b>을 중심으로 코디를 구성했어요.<br><br>
    ...
    <div class="result-card">
        ...
        <div class="result-text">
            선호하는 <b>{style}</b> 스타일을 중심으로 구성했어요.<br><br>
